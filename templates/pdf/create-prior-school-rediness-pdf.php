<?php 
	...
	$pdf->SetTitle('Prior School Rediness summary'); 
	$pdf->SetSubject('Prior School Rediness summary');
	$pdf->SetKeywords('Prior School Rediness summary'); 
	...
	$pdf->writeHTMLCell(200, '', '', '', '<i>'.date("jS M Y",strtotime('tomorrow')).'</i>', 0, 1, 1, true, 'C', true);
	...
	$PdfName = CUS_WOO_ORDER_PLUGIN_DIR.'/pdffile/prior_school_rediness_'.$stateCode.'.pdf';
